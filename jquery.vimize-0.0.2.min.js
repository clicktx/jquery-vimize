...
console.log(z.keyCode);console.log(m);if(z.keyCode==27){f(z.keyCode);}else{if(z.ctrlKey){g(z.keyCode,i);}}if(i.length){return;}if(z.shiftKey){t(z.keyCode);
return false;}else{if(q=="cmd"){l(z.keyCode);return false;}else{if(z.keyCode==71){y(z.keyCode);return false;}else{ret=w(z.keyCode);console.log(ret);return ret;
}}}});};})(jQuery);